...
LoopColumnLine:
	...
	li  $v0, 1			# DEBUG PARA COMPROBAR, MEDIANTE EL CONTENIDO DEL ARRAY_C, QUE SE ACCEDE EN EL ORDEN CORRECTO
      	lw $a0,0($s4)			# DEBUG PARA COMPROBAR, MEDIANTE EL CONTENIDO DEL ARRAY_C, QUE SE ACCEDE EN EL ORDEN CORRECTO
      	syscall				# DEBUG PARA COMPROBAR, MEDIANTE EL CONTENIDO DEL ARRAY_C, QUE SE ACCEDE EN EL ORDEN CORRECTO
      	li   $v0, 4			# DEBUG PARA COMPROBAR, MEDIANTE EL CONTENIDO DEL ARRAY_C, QUE SE ACCEDE EN EL ORDEN CORRECTO
      	la   $a0, Msg6			# DEBUG PARA COMPROBAR, MEDIANTE EL CONTENIDO DEL ARRAY_C, QUE SE ACCEDE EN EL ORDEN CORRECTO
      	syscall
...
END:
	...
	li   $v0, 4			# MOSTRAR MENSAJE PARA SALIR O NO
        ...
        li $a1,2          # CARGAMOS EN $a0 LA DIRECCION DEL BUFFER DONDE SE ALMACENARA LA RESPUESTA
