...
LoopColumnLine:
	...
	li   $v0, 1			# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
      	add   $a0, $t7, $zero		# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
     	syscall				# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
      	li   $v0, 4			# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
      	la   $a0, Msg6			# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
      	syscall				# DEBUG PARA COMPROBAR QUE LA POSICION j*n+i SE CALCULA CORRECTAMENTE
